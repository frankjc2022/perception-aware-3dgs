...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            num_rendered, num_buckets, color, radii, geomBuffer, binningBuffer, imgBuffer, sampleBuffer, countBuffer, listBuffer, listBufferRender, listBufferDistance, centers, depths, my_radii, accum_weights, accum_count, accum_blend, accum_dist, invdepths = _C.rasterize_gaussians(*args)
        ...
        return color, radii, countBuffer, listBuffer, listBufferRender, listBufferDistance, centers, depths, my_radii, accum_weights, accum_count, accum_blend, accum_dist, invdepths

    @staticmethod
    def backward(ctx, grad_out_color, _, dumy, wumy, pumy, fumy, g_center, g_depth, g_radii, g_weights, g_count, g_blend, g_dist, __):
